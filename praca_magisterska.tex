...
Uczenie sieci neuronowej będzie odbywało się za pomocą algorytmu propagacji wstecznej (patrz algorytm \ref{bp}) z kwadratową funkcją straty (można też wykorzystać inną, \mbox{np. entropię}). 
