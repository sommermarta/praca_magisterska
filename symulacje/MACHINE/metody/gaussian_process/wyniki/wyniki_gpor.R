...
setwd("C:/Users/Marta/Desktop/Marta/GitHub/praca_magisterska/symulacje/MACHINE/metody/gaussian_process/wyniki")
...
write.table(tabela, "..\\..\\..\\wnioski\\gpor.txt", col.names=TRUE, 
